...
const msgExito = document.getElementById("modalCrearEquipoOk");

if (msgExito) {
    const modal = new bootstrap.Modal(
        document.getElementById("modalCrearEquipoOk")
    );
    modal.show();
    setTimeout(() => {
...
const msgError = document.getElementById("modalErrorCrearEquipo");

if (msgError) {
    const modal = new bootstrap.Modal(
        document.getElementById("modalErrorCrearEquipo")
    );
    modal.show();
}